...
print("###########################")
print("############TUPLAS#########")
my_tupla = tuple(my_lista)              #convierto mi lista en tuplas
print()
print()
print("my_tuple: ", my_tupla)

print(my_tupla[0])                     #Imprimo la posicion 0 de la tupla            
print(my_tupla[2])                     #Imprimo la posicion 2 de la tupla


#Evaluar si un elemento está contenido en la tupla (Devuelve un valor booleano)
print('Rojo' in my_tupla)              #verifica si el objeto 'rojo' esta en la tupla y devuelve un true o false
print(my_tupla.count('Rojo'))          #imprime la posicion en que se encuentra el objeto 'rojo' si esta en la tupla
